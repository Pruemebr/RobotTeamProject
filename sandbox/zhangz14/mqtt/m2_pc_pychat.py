...
Authors: David Fisher and Zikang Zhang.
...
def main():
    ...
    my_name = "Zik"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Bryce"  # Used to set the topic that you will *publish to*
