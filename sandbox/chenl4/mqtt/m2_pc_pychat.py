...
Authors: David Fisher and Lilin Chen.
...
def main():
    ...
    my_name = "Lilin Chen"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Pruemebr"  # Used to set the topic that you will *publish to*
